...
public class PlayerDodginState : PlayerBaseState
{
    ...
    public PlayerDodginState(PlayerStateMachine stateMachine, Vector3 dodgingDirectionInput) : base(stateMachine)
    {
